...
public class ProtoDecoder extends CumulativeProtocolDecoder {
    ...
    // // int startIndex = in.position();
    // // in = in.getSlice(startIndex, length);
    // // System.out.println(in);
    //
    // }
    // }
    ...
    // if (in.position() == 0) {
    // array = in.array();
    // offset = in.arrayOffset() + in.markValue();
    // } else {
    // array = new byte[length];
    // in.get(array, 0, length);
    // offset = 0;
    // }
    //
    // if (extensionRegistry == null) {
    // out.write(prototype.newBuilderForType().mergeFrom(array, offset,
    // length).build());
    // } else {
    // out.write(prototype.newBuilderForType().mergeFrom(array, offset, length,
